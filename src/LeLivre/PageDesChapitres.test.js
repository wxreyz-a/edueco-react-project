...
describe('ChapterIndex Component', () => {
  test('renders main heading and chapter links', () => {
    ...
    expect(screen.getByRole('heading', { name: /Chapitre 1 :/i })).toHaveTextContent(/histoire de l/i);
    expect(screen.getByRole('link', { name: /Chapitre 1 :/i })).toHaveAttribute('href', '/parties-chapitre-un');
    ...
    expect(screen.getByRole('heading', { name: /Chapitre 4 : Psychologie/i })).toBeInTheDocument();
    expect(screen.getByRole('link', { name: /Chapitre 4 : Psychologie/i })).toHaveAttribute('href', '/parties-chapitre-quatre');
  });
